...
var MORRISSEY_EXCUSES = [
    "I am ill.",
    "I have a severe sinusitis attack.",
    "I have influenza.",
    "I have a bleeding ulcer.",
    "I have Barrett's esophagus.",
    "I have double pneumonia.",
    "I blew out my voice.",
    "I was forced off stage by the smell of burning meat.",
    "Our drummer has passed away.",
    "Ticket sales have been poor.",
    "My keyboardist has been hospitalized.",
    "There has been a mismanagement of tour funds.",
    "The heater at the venue isn't working.",
    "There is a global pandemic and public gatherings are banned.",
    "I am suffering from extreme exhaustion.",
    "Authorities have warned of a credible security threat against me while on stage.",
    "I am travel-weary beyond belief.",
    "There is zero music industry support, which has led to a complete lack of tour funds.",
    "Festival noise from the neighboring stage left me unable to sleep last night.",
    "I had an adverse reaction to a prescription medication.",
    "I walked away from the tour I was supporting.",
    "I have suffered a series of medical mishaps over the past few months.",
    "My band members have sustained injuries.",
    "I am experiencing extreme fatigue and cannot take the stage.",
    "The tour has been mismanaged beyond repair.",
    "I have no label support whatsoever.",
    "I cannot in good conscience take the stage in my current condition.",
    "I am recovering from a serious illness and my doctor has advised against performing.",
    "The conditions at this venue are not conducive to a performance.",
    "I am not well enough to perform at the level my audience deserves.",
    "My health must take priority over any performance obligations.",
...
function getExcuse() {
    const useRick = Math.random() < 0.5;
    if (useRick) {
        const idx = Math.floor(Math.random() * RICK_EXCUSES.length);
        excuseText.innerText = RICK_EXCUSES[idx];
        currentAuthor = 'Rick';
    } else {
        const idx = Math.floor(Math.random() * MORRISSEY_EXCUSES.length);
        excuseText.innerText = MORRISSEY_EXCUSES[idx];
        currentAuthor = 'Morrissey';
    }
